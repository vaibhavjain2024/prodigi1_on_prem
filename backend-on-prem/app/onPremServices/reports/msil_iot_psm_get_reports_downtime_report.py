...
from app.modules.PSM.repositories.msil_report_downtime_repository import MSILReportDowntimeRepository
from app.modules.PSM.services.msil_report_downtime_service import MSILReportDowntimeService
...
# folder = "reports_downtime_reports/"
    
# def upload_to_s3():
#     report_name = "Reports_downtime_report_" + str(uuid.uuid4()) + ".csv"
...
def handler(shop_id, start_date, end_date, request, **query_params):
    ...
    return get_plans(
        service=report_downtime_service, 
...
def get_plans(**kwargs):
    ...
    try :
        ...
        service : MSILReportDowntimeService  = kwargs["service"]  
        ...
        return service.get_reports_downtime_report(
            None, 
            shop_id, 
            start_date, 
            end_date, 
        ...
        #     service.get_reports_downtime_report(csvwriter, shop_id,
        #                                         start_date=start_date,
        #                                         end_date=end_date, 
        #                                 model_list=model_list,
        #                                 machine_list=machine_list,
...
#             return get_plans(service=report_downtime_service, 
#                              query_params=query_params, \
#                              username=username, 
#                              role=role, 
#                              shop_id=shop_id)
