...
@authorize(shop_auth)
def get_reports_downtime(**kwargs):
    """Get plans 
    ...
    try :
        ...
        return service.get_downtime_data(
            shop_id,
            start_date,
            end_date,
        ...
        # response = service.get_downtime_data(shop_id,start_date=start_date,
        #                                             end_date=end_date,
        #                                 model_list=model_list,
        #                                 machine_list=machine_list,
        #                                 part_name_list=part_name_list,
...
#             return get_reports_downtime(service=report_downtime_service, 
#                                         query_params=query_params, \
#                                         username=username, 
#                                         role=role,
#                                         shop_id=shop_id)
