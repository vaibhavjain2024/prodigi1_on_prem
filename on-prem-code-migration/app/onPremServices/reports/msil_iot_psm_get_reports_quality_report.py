...
from modules.PSM.repositories.msil_report_quality_repository import MSILReportQualityRepository
from modules.PSM.services.msil_report_quality_service import MSILReportQualityService
...
# folder = "reports_quality_reports/"
    
# def upload_to_s3():
#     report_name = "Reports_quality_report_" + str(uuid.uuid4()) + ".csv"
...
def get_plans(**kwargs):
    ...
    try :
        ...
        return service.get_reports_quality_report(
            None,
            shop_id,
            start_date,
            end_date,
        ...
        #     service.get_reports_quality_report(csvwriter, shop_id,
        #                                        start_date=start_date,
        #                                         end_date=end_date,
        #                                 model_list=model_list,
        #                                 machine_list=machine_list,
...
#             return get_plans(service=report_quality_service,
#                               query_params=query_params, \
#                               username=username, 
#                               role=role, 
#                               shop_id=shop_id)
