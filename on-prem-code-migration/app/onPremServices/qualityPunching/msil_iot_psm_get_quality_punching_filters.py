...
def get_quality_punching_filters(**kwargs):
    ...
    try :
        ...
        return service.get_quality_part_filters(shop_id)
        # return {
        #     'statusCode': 200,
...
#     quality_punching_service = MSILQualityPunchingService(msil_quality_punching_repository,
#                                         msil_equipment_repository,
#                                         msil_part_repository,
#                                         msil_model_repository,quality_update_repo)
...
#             return get_quality_punching_filters(service=quality_punching_service, 
