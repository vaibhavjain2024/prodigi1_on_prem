...
def machine_view_graph(**kwargs):
    ...
    try:
        ...
        return service.machine_view_graph(
            shop_id,
            view=view,
            machine_name=machine_name,
        )

        # response = service.machine_view_graph(shop_id,
...
#             return machine_view_graph(service=msil_equipment_service, 
#                                  query_params=query_params, \
#                                 username=username, 
#                                 role=role,
#                                 shop_id=shop_id)
