...
from app.modules.IAM.repositories.permissions_repository import PermissionsRepository
from app.modules.IAM.services.permissions_service import PermissionsService
from app.modules.IAM.session_helper import SessionHelper
from app.services.sync_user_data_service import sync_users_data, sync_adfs_users_data
...
async def sync_user(cron_job_id:str, start_time:str):
    ...
    role_repository = RoleRepository(rbac_session)
    ...
    try:
        ...
        status_code, message = await sync_users_data(messages_list['messages'], cron_job_id, start_time, user_service, role_service)
        if status_code:
            return JSONResponse(
