...
import requests
import threading
from app.config.config import SERVICE_NAME, IS_LOG_SEND_TO_CW
from app.config.config import AWS_API_GATEWAY_KEY, LOG_GROUP_NAME, SYNC_BASE_GATEWAY_URL_LISTS, AWS_CLOUD_WATCH_URL
